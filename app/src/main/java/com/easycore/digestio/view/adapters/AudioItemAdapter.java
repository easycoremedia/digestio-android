...
public class AudioItemAdapter extends RecyclerView.Adapter<AudioItemAdapter.AudioItemViewHolder> {
    ...
    public void onBindViewHolder(final AudioItemViewHolder holder, final int position) {
        ...
        if (item.isPlaying()) {
            holder.imvProgress.setImageDrawable(context.getResources()
                    .getDrawable(R.drawable.ico_pause));
            final Handler handler = new Handler();
            handler.postDelayed(new TimerTask() {
                @Override
                public void run() {
                    if (item.isPlaying()) {
                        holder.progress.setProgress((int) item.getPlayingProgress());
            ...
            holder.imvProgress.setImageDrawable(context.getResources()
                    .getDrawable(R.drawable.ico_play));
    ...
    public class AudioItemViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.audio_item_imv_progress)
        protected ImageView imvProgress;
        @BindView(R.id.audio_item_progress)
